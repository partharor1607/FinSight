...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    showToast('Signing in...', 'loading', 5000)
    ...
    try {
      ...
      if (result.type === 'auth/login/fulfilled') {
        ...
        showToast(`Sign in successful! Welcome back, ${userName}! 🎉`, 'success', 4000)
      } else if (result.type === 'auth/login/rejected') {
        // Show error toast
        const errorMessage = result.payload || 'Invalid email or password. Please try again.'
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Welcome to FinSight</h2>
